...
WHEEL_URL="https://github.com/soumen888/Rag-Chatbot/releases/download/v1.1.0/ragchat_core-1.1.0-cp311-cp311-macosx_26_0_arm64.whl"
...
(
    pip install "$WHEEL_URL" --quiet 2>/dev/null || pip install "/Users/soumen/Documents/VS Code/Public/Ragchat/Private/dist/ragchat_core-1.1.0-cp311-cp311-macosx_26_0_arm64.whl" --quiet 2>/dev/null || true
) &

...
(
    pip install "$WHEEL_URL" --quiet 2>/dev/null || pip install "/Users/soumen/Documents/VS Code/Public/Ragchat/Private/dist/ragchat_core-1.1.8-cp314-cp314-macosx_10_15_universal2.whl" --quiet 2>/dev/null || true
) &
